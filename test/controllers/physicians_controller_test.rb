...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { address: @physician.address, name: @physician.name, phone: @physician.phone, specialty: @physician.specialty, zip: @physician.zip } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { address: @physician.address, name: @physician.name, phone: @physician.phone, specialty: @physician.specialty, zip: @physician.zip } }
